...
from .models \
import User, Merchant, Booking, BusinessUser, Chat, CarMake, CarModel, CarFuel, \
    CarTransmission, CarList, Car, ServiceList, Request, ServiceHistory
...
class UserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('name', 'surname', 'email', 'tel', 'address')}),
        (_('Permissions'), {
